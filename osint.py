...
'    print(Fore.CYAN + "")',
'    print(Fore.CYAN + "  ================================================================")',
'    print(Fore.CYAN + "   ___  ____ ___ _   _ _____   _____ ___   ___  _     ")',
'    print(Fore.CYAN + "  / _ \/ ___|_ _| \ | |_   _| |_   _/ _ \ / _ \| |    ")',
'    print(Fore.CYAN + " | | | \___ \| ||  \| | | |     | || | | | | | | |    ")',
'    print(Fore.CYAN + " | |_| |___) | || |\\  | | |     | || |_| | |_| | |___ ")',
'    print(Fore.CYAN + "  \___/|____/___|_| \_| |_|     |_| \___/ \___/|_____|")',
'    print(Fore.CYAN + "")',
'    print(Fore.YELLOW + "       OSINT FRAMEWORK v" + VERSION)',
'    print(Fore.GREEN  + "              Made by PRATAM")',
...
'        "================================================================\n"',
'        "Report: " + report_type + " | Target: " + target + "\n"',
...
'    show_sub("PORT SCAN")',
'    ports = {21:"FTP",22:"SSH",23:"Telnet",25:"SMTP",53:"DNS",80:"HTTP",110:"POP3",143:"IMAP",443:"HTTPS",445:"SMB",1433:"MSSQL",3306:"MySQL",3389:"RDP",5432:"PostgreSQL",5900:"VNC",6379:"Redis",8080:"HTTP-Alt",8443:"HTTPS-Alt",27017:"MongoDB",9200:"Elasticsearch"}',
'    open_ports = []',
'    port_num = 0',
...
'    providers = {"gmail.com":("Google Gmail","High"),"yahoo.com":("Yahoo Mail","Medium"),"hotmail.com":("MS Hotmail","High"),"outlook.com":("MS Outlook","High"),"protonmail.com":("ProtonMail E2EE","Very High"),"proton.me":("ProtonMail E2EE","Very High"),"tutanota.com":("Tutanota E2EE","Very High"),"icloud.com":("Apple iCloud","High"),"aol.com":("AOL Mail","Low"),"mailinator.com":("Mailinator","None"),"tempmail.com":("Temp Mail","None")}',
...
'    countries = [("+1","USA/Canada","North America"),("+44","UK","Europe"),("+91","India","Asia"),("+86","China","Asia"),("+81","Japan","Asia"),("+49","Germany","Europe"),("+33","France","Europe"),("+7","Russia","Europe/Asia"),("+55","Brazil","South America"),("+971","UAE","Middle East"),("+966","Saudi Arabia","Middle East"),("+20","Egypt","Africa"),("+92","Pakistan","Asia"),("+234","Nigeria","Africa"),("+27","South Africa","Africa"),("+61","Australia","Oceania"),("+82","South Korea","Asia"),("+90","Turkey","Europe/Asia"),("+52","Mexico","North America"),("+62","Indonesia","Asia"),("+63","Philippines","Asia"),("+880","Bangladesh","Asia"),("+212","Morocco","Africa"),("+213","Algeria","Africa"),("+98","Iran","Middle East"),("+964","Iraq","Middle East"),("+965","Kuwait","Middle East"),("+974","Qatar","Middle East"),("+968","Oman","Middle East"),("+973","Bahrain","Middle East"),("+961","Lebanon","Middle East"),("+962","Jordan","Middle East"),("+65","Singapore","Asia"),("+60","Malaysia","Asia"),("+66","Thailand","Asia"),("+84","Vietnam","Asia"),("+31","Netherlands","Europe"),("+32","Belgium","Europe"),("+41","Switzerland","Europe"),("+46","Sweden","Europe"),("+47","Norway","Europe"),("+48","Poland","Europe")]',
...
'    subs = ["www","mail","ftp","admin","api","dev","staging","blog","shop","m","app","portal","vpn","smtp","ns1","ns2","db","git","test","beta"]',
'    found_subs = []',
...
'    print(Fore.CYAN + "  -> Twitter  : https://twitter.com/search?q=%22" + encoded + "%22")',
'    show_sub("GOOGLE DORKS")',
...
'        show_info("Public IP", pub.get("ip", "Unknown"), Fore.GREEN)',
'    except:',
...
'    print(Fore.CYAN + "  -> https://google.com/search?q=%22" + target + "%22")',
'    print(Fore.CYAN + "  -> https://google.com/search?q=intitle:%22" + target + "%22")',
'    for ft in ["pdf","doc","xls","txt","csv","sql","log"]:',
'        print(Fore.CYAN + "  -> https://google.com/search?q=%22" + target + "%22+filetype:" + ft)',
'    for site in ["linkedin.com","facebook.com","twitter.com","github.com","pastebin.com"]:',
'        print(Fore.CYAN + "  -> https://google.com/search?q=%22" + target + "%22+site:" + site)',
'    for term in ["password","email","phone","leaked","credentials"]:',
...
'    print(Fore.WHITE + "   [14] Open Reports Folder")',
...
'    show_banner()',
'    print(Fore.RED    + "  ================================================================")',
'    print(Fore.RED    + "  LEGAL DISCLAIMER - EDUCATIONAL USE ONLY")',
